...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
      .setTitle("Benji BOT PRIVACY POLICY")
      .setThumbnail(icon)
    ...
    We never share your data with anyone except for [MongoDB Inc](https://mongodb.com) whom is a DataBase Company and all the data for our Bot is stored on the MongoDB Servers and According to MongoDB Inc. the data is only accessable by us.`
      ...
      .addField(
        ...
        `
    If you have any concerns or queries relating our privacy policy or our bot or if you want your data to be removed, You can contact [𝐵𝑒𝓃𝒿𝒾#0911] or https://discord.gg/G3wXrxNQpP `
      )
